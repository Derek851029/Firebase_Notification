    ...
    render() {
        ...
        return (
          <View style={styles.container}>
            <WebView
              source={{uri: 'http://210.68.227.123:8006/Mobile_Login.aspx?login='+this.state.usertoken+'&page=10&Agent_ID='+this.state.agentid+'&date='+this.state.today+'&Agent_LV=70'}}
              style={styles.video}
            />
          </View>
        );
